         ...
         <div class="card-body" style="padding:30px">
            ...
            <form method="POST" action="{{url('/actor/edit/'.$actor->id)}}">
	            ...
	            <div class="form-group">
	               ...
	               <input type="text" name="nom_actor" id="nom_actor" class="form-control" value="{{$actor->nom_actor}}">
	            </div>

	            <div class="form-group">
	               <label for="nacionalitat">Nacionalidad</label>
	               <input type="text" name="nacionalitat" id="nacionalitat" class="form-control" value="{{$actor->nacionalitat}}">
	            </div>
